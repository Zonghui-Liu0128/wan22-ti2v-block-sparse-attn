...
: "${DATASET_BASE_PATH:=/srv/workspace/Kirin_AI_Workspace/TMG_I/l00832862/Smart_Doll_Pet-master/datasets/dataset_dolls_480p}"
: "${DATASET_METADATA_PATH:=/srv/workspace/Kirin_AI_Workspace/TMG_I/l00832862/Smart_Doll_Pet-master/datasets/metadata/metadata_dataset_dolls_480p.csv}"
: "${MODEL_PATHS:=/srv/workspace/Kirin_AI_Workspace/TMG_I/l00832862/shared_checkpoints/Wan2.2-TI2V-5B/}"
: "${TOKENIZER_PATH:=}"
...
: "${LORA_RANK:=32}"
: "${LORA_CHECKPOINT=models/step-66900.safetensors}"
...
: "${OUTPUT_PATH:=/srv/workspace/Kirin_AI_Workspace/TMG_I/l00832862/Smart_Doll_Pet-master/outputs/train/Wan2.2-TI2V-5B_lora_pets/bsa_${BSA_SPARSE_RATIO}}"
: "${CACHE_PATH:=/srv/workspace/Kirin_AI_Workspace/TMG_I/l00832862/Smart_Doll_Pet-master/outputs/cache/Wan2.2-TI2V-5B_lora_pets_832x480x81}"
: "${USE_CACHE:=0}"
...
model_args=(--model_paths "${MODEL_PATHS}")
...
add_value lora_args --lora_checkpoint "${LORA_CHECKPOINT}"
...
add_flag train_args "${OPTIMIZER_FUSED}" --optimizer_fused
add_flag train_args "${ENABLE_TENSORBOARD}" --enable_tensorboard
add_value train_args --max_train_steps "${MAX_TRAIN_STEPS}"
